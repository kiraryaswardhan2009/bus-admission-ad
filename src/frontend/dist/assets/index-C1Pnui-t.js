...
const Bus = createLucideIcon("bus", __iconNode$e);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "footer",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-1 w-full bg-primary", "aria-hidden": "true" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid sm:grid-cols-2 lg:grid-cols-4 gap-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 lg:col-span-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-full bg-primary flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Bus,
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "leading-tight", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-secondary-foreground text-sm", children: "Saraswati" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-secondary-foreground text-sm", children: "Shishu Mandir" })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-secondary-foreground/65 text-sm leading-relaxed", children: "Nurturing young minds with knowledge, discipline, and cultural values since our founding. Admissions open for 2026-2027." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display font-bold text-secondary-foreground text-sm mb-4 uppercase tracking-wide", children: "Quick Links" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2", children: footerLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "a",
                {
                  href: link.href,
                  onClick: (e) => {
                    e.preventDefault();
                    scrollTo$3(link.href);
                  },
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display font-bold text-secondary-foreground text-sm mb-4 uppercase tracking-wide", children: "Bus Services" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-2 text-secondary-foreground/65 text-sm", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "GPS-Tracked Yellow Bus" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Trained Conductor On Board" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Licensed Safe Driver" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "First Aid & CCTV Equipped" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Door-to-Door Route Coverage" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display font-bold text-secondary-foreground text-sm mb-4 uppercase tracking-wide", children: "Contact" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-2.5 text-sm text-secondary-foreground/65", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "text-secondary-foreground/65 text-sm pl-6", children: "Principal: Govind Patel" })
              ] })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-10 pt-6 border-t border-secondary-foreground/15 flex flex-col sm:flex-row items-center justify-between gap-3 text-secondary-foreground/50 text-xs", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
              "© ",
              year,
              " Saraswati Shishu Mandir. All rights reserved."
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-50 bg-card border-b border-border shadow-sm", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between h-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        ...
        {
          type: "button",
          onClick: () => scrollTo$2("#home"),
          className: "flex items-center gap-2.5 group",
          "data-ocid": "header.logo_link",
          "aria-label": "Saraswati Shishu Mandir — go to top",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-full bg-primary flex items-center justify-center shadow-md group-hover:scale-105 transition-smooth", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              Bus,
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "leading-tight", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-secondary text-sm sm:text-base leading-none", children: "Saraswati" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-secondary text-sm sm:text-base leading-none", children: "Shishu Mandir" })
            ] })
          ]
        }
      ),
...
const highlights = [
  { icon: CircleCheckBig, label: "GPS Tracked Every Route" },
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-14 pb-16 lg:pt-20 lg:pb-24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-12 items-center", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "h1",
              {
                ...
                children: [
                  "Admissions Open for",
                  " ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "Saraswati Shishu Mandir" }),
                  " ",
                  "School"
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-muted-foreground leading-relaxed max-w-lg", children: "Safe and comfortable school bus service available for all enrolled students. Experience premium transport with trained staff, GPS tracking, and first-aid equipped vehicles — every single day." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "flex flex-col sm:flex-row gap-3 flex-wrap", children: highlights.map(({ icon: Icon2, label }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "li",
              {
                className: "flex items-center gap-2 text-sm font-medium text-foreground",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "w-4 h-4 text-primary flex-shrink-0" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative rounded-2xl overflow-hidden border-4 border-primary/30 shadow-2xl w-full max-w-[520px]", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "img",
                    {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-4 left-4 bg-secondary text-secondary-foreground rounded-xl px-4 py-2 shadow-lg", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold uppercase tracking-wide opacity-80", children: "School Bus" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-primary text-sm leading-tight", children: "2026-2027 Fleet Ready" })
                  ] })
                ] })
              ]
            }
          ...
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "svg",
              {
                ...
                role: "presentation",
                children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M0,20 C360,40 1080,0 1440,20 L1440,40 L0,40 Z" })
              }
            )
          }
        )
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-14 items-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "bg-secondary/10 text-secondary border-secondary/30 font-semibold tracking-wide text-xs uppercase", children: "About Our School" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "h2",
              {
                ...
                children: "Saraswati Shishu Mandir"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "yellow-accent-bar", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-base leading-relaxed", children: "Rooted in the values of knowledge, discipline, and cultural pride, Saraswati Shishu Mandir has been shaping young minds for decades. We believe every child deserves an environment where they can thrive academically, socially, and morally." }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-base leading-relaxed", children: "We are now accepting applications for the academic year 2026-2027. Secure your child's seat today and pair it with our safe, fully-equipped school bus service — covering all major routes in the area." }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-3 pt-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-4", "data-ocid": "school.values_list", children: values.map(({ icon: Icon2, title, desc }, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Card,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-shrink-0 w-11 h-11 rounded-xl bg-primary/15 flex items-center justify-center mt-0.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "w-5 h-5 text-primary" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-secondary text-base mb-1", children: title }),
      ...
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4 sm:px-6 lg:px-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12 space-y-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "bg-primary/15 text-secondary border-primary/30 font-semibold tracking-wide text-xs uppercase", children: "School Information" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "h2",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-base max-w-lg mx-auto", children: "Everything you need to know about our school — from leadership to facilities." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: schoolDetails.map(({ icon: Icon2, label, value, color }, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                Card,
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-0 space-y-4", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-xs font-semibold uppercase tracking-widest mb-1", children: label }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-secondary text-base leading-snug", children: value })
                    ] })
                  ] })
                },
                label
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4 sm:px-6 lg:px-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12 space-y-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "bg-primary/20 text-primary border-primary/40 font-semibold tracking-wide text-xs uppercase", children: "Get In Touch" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "h2",
              {
                id: "contact-heading",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-secondary-foreground/70 text-lg max-w-lg mx-auto", children: "Reach out to us for admission queries, bus route details, or any other questions." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-6 max-w-2xl mx-auto", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Card,
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-0 space-y-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-flex w-12 h-12 rounded-full bg-primary/20 items-center justify-center mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "w-5 h-5 text-primary" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-secondary-foreground text-base", children: "Phone" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "a",
                    {
                      href: "tel:+916264462892",
                      ...
                      children: "+91 62644 62892"
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-secondary-foreground/60 text-xs", children: "Mon–Sat, 8 AM – 2 PM" })
                ] })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Card,
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-0 space-y-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-flex w-12 h-12 rounded-full bg-primary/20 items-center justify-center mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-5 h-5 text-primary" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-secondary-foreground text-base", children: "Address" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-secondary-foreground/80 text-sm leading-relaxed", children: [
                    "Saraswati Shishu Mandir,",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                    "Tendukheda,",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-12 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              ...
              children: "🎒 Register Your Child Today"
            }
          ) })
        ] })
      }
...
function ServiceCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Card,
    {
      ...
      "data-ocid": `services.card.${index2}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `${styles.header} px-6 py-5 relative overflow-hidden`, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute right-4 top-1/2 -translate-y-1/2 opacity-20", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "w-16 h-16", strokeWidth: 1.5 }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: `${styles.badge} font-semibold text-xs mb-2`, children: subtitle }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-xl leading-tight", children: title })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-6 flex flex-col gap-4 flex-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed", children: description }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2.5 mt-1", children: features.map(({ icon: FIcon, text }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "li",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(FIcon, { className: "w-3.5 h-3.5" })
                  }
                ),
                text
              ]
...
const services = [
  {
    ...
    description: "Our well-maintained yellow school buses are equipped with every amenity to ensure a safe, clean, and comfortable journey for your child every single day.",
    features: [
...
function ServiceHighlights() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4 sm:px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12 space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "bg-primary/15 text-primary border-primary/30 font-semibold tracking-wider text-xs uppercase", children: "Why Choose Us" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h2",
            {
              id: "services-heading",
              ...
              children: "Everything Your Child Needs"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-lg max-w-xl mx-auto leading-relaxed", children: "From GPS-tracked routes to certified personnel — we leave nothing to chance when it comes to your child's safety." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-md mx-auto", "data-ocid": "services.cards_list", children: services.map((service, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(ServiceCard, { ...service, index: i + 1 }, service.title)) })
      ] })
    }
  );
}
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-background", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(ServiceHighlights, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(SchoolInfo, {})
    ] }),
